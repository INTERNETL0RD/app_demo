...
class FirestoreService {
  ...
  Future updateUser(String uid, String date, String userRole, String picUrl, String bkdUrl) async {
    await _usersCollectionReference
        .document(uid)
        .updateData({'date': date, 'userRole': userRole, 'picUrl': picUrl, 'bkdPicUrl' : bkdUrl});
  }
}
